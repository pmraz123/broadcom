...
def show_vco_info():
    ...
    try:
        ...
        if status == True and data_type == "dict":   
            #print(type(data))
            print("Login to VCO:",colored(vco_class.base_url, 'green'))
            print("-" * 120)
            ...
            print(colored("Something wrong. Here are details of collected data:", 'red'))
            print(data)
            print(type(data))
        ...
        if status2 == True and data_type2 == "dict":
            ...
            print(colored("Something wrong. Here are details of collected data2:", 'red'))
            #print(data2)
            print(type(data2))
            pass
...
@click.command()
@click.option("--option", help="TBD")
@click.option("--hostnames-filename", help="hostname of device (from VCO), in txt file, separated by spaces, columns, or semicolons. Files are in folder USERS_INPUTS. ")
def collect_edges_info(option, hostnames_filename):
    """ 
    \b
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    collect_edge_info - Collect data from VCO, for devices deffined in hostnames_filename. File is in folder USERS_INPUTS
    \b
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    \b
    ...
    --------------------------------------
    \b
    --hostnames-filename    = hostname of device (from vManage), in txt file, separated by spaces, columns, or semicolons. Files are in folder USERS_INPUTS.
    \b
    --------------------------------------   
    Example:
    --------------------------------------
    python3 velocloud.py --customer customer1  collect-edges-info --hostnames_filename az_stores_2023_08_31_CL1.txt 
    \b
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    """ 
    ...
    try:
        ...
        line_print = 120
        print("-" * 120)
        print("Command executed: python3 velocloud.py --customer", CUSTOMER, "collect-edges-info", "--hostnames-filename", hostnames_filename )
        #exit(0)
        # hint - progress bar
        print("-" * 120)              
        print(colored("Collecting info via API calls:", 'green'))
...
# -----------------------------------------------------------------------------------------------------------------------------------------------
# -----------------------------------------------------------------------------------------------------------------------------------------------
# ----------------------- THESE ARE NOT USED YET, still those are original developed for Cisco SDWAN, may be soon converted for VCO -------------
# -----------------------------------------------------------------------------------------------------------------------------------------------
# -----------------------------------------------------------------------------------------------------------------------------------------------
# -----------------------------------------------------------------------------------------------------------------------------------------------
...
cli.add_command(collect_edges_info)
